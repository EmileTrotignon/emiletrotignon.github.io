...
let () =
  write_all "fr.tex" (Resume_builder.to_latex Instance.emile Multi_string.French) ;
  write_all "en.tex" (Resume_builder.to_latex Instance.emile Multi_string.English) ;
