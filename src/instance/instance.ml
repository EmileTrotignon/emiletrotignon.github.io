...
let emile =
  Resume.make ~firstname:(I "Émile") ~lastname:(I "Trotignon")
    ...
    ~experiences:
               ...
               ~french:
                 (md
                    "Stage de 4.5 mois supervisé par Vincent Laviron et Pierre \
                     Chambart. Généralisation de l'optimisation des appels \
      ...
      ; experience
          (v ~french:"Stage de recherche en géométrie algorithmique"
      ...
      ; experience
          ...
          (v ~french:"Junior entreprise de l'ENS Paris-Saclay"
             ~english:"Junior enterprise of ENS Paris-Saclay" )
    ...
    ~skills:
      [ skill
          (v ~english:"Functional programming"
               ...
               ~english:
                 (md
                    "I am very interested in compilation. In this domain, for \
                     ...
                     ML-style language to X86. The code is available here: \
                     [github/cours-compilation-p7](https://github.com/EmileTrotignon/cours-compilation-p7).\n\
